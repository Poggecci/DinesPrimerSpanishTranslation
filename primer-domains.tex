...
\pos{%
\noindent
\ysf{Excluimos de nuestro trato de dominios cuestiones de asuntos biológicos y % "tratamiento" feels off here
psicológicos.}}{}
...
\pind Los endurantes de dominio, cuando eventualmente se modelan en software, típicamente
      ...
      estructuras de datos para software, incluyendo las bases de datos.
\afslut
%%%%%%%
...
\pind Como veremos, en \pos{el}{la} siguiente \pos{capítulo}{sección},
\begynd
...
\noindent
\pind Las partes son los ``caballos de trabajo'' de los dominios hechos por el hombre.  % Unsure how to translate workhorse idiom
...
\pind \newestpdefn{Mereología, I}{ La mereología es \pdefindex{mereology}\  
      una teoría de las relaciones de partes [de endurantes]: % doubts about part-hood
\begynd 
...
\pind pero que pueden ser
      físicamente
\pind (electrónicamente, químicamente de otra manera)
...
\nbbbbb{Indicaciones}\label{primer.Prompts}
...
\begynd
\pind que nosotros, como analistas y descriptores de dominio,
...
\afslut}
%%%%%%%
\monoexample{Un estado del sistema de carreteras}{ El analista y descriptor del dominio
