...
\include{primer-forsider}

\mainmatter

\include{primer-intro}    % Introduction
 
\include{primer-filosofi} % Philosophy

\include{primer-domains}  % Domains
...
\include{primer-perd}     % Perdurants
...
\include{primer-road}% Example
\pos{\label{primer-example.n}}{}

\include{app-pipeline}% Example

\include{primer-rsl}  % 

\include{primer-indexes}  % 
